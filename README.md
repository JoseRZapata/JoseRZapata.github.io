...
- Download and extract the Academic theme files from the hugo-academic-master 
folder to the themes/academic/ folder in Academic Kickstart
- Info to have all the website in 1 project, Master (branch) public html, 
source (branch) source code to generate the web page
